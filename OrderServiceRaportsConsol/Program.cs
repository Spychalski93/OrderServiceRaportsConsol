                ...
                try
                {
                    ...
                    switch (selectOption)
                    {
                        ...
                        case 9:
                            ...
                            ascendingOrDescending = ChoiceAscendingOrDescending();
                            raport = "Ilośc zamówień pogrupowane po nazwie produktów: " + Environment.NewLine 
                        ...
                        case 10:
                            ...
                            sortingMethod = SortingMethodGroupByName();
                            ascendingOrDescending = ChoiceAscendingOrDescending();
                            raport = "Ilośc zamówień pogrupowane po nazwie produktów dla klienta o id'" + clientId + "': " 
                                + Environment.NewLine 
        ...
        private static void ReadListFiles(List<string> fileList)
        {
            foreach (var item in fileList)
            {
                if (item.EndsWith(".csv"))
                    ...
                    Console.WriteLine("wczytano xml");
                else if (item.EndsWith(".json"))
                    Console.WriteLine("wczytano json");
                else
                {
